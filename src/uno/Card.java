...
public class Card implements Comparable<Card>{
	 ...
	 * returns -1 if the first card has a lower symbol than the second
	 * returns 1 otherwise
	 * If the symbols are the same, but the colors are not, either -1 or 1 is returned
