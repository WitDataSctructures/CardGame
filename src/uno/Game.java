...
public class Game {
	 ...
	 * 
	 * @return <b>True</b> if a server was successfully created or connected to. <b>False</b> if the player does not want to host and cannot connect to server.
	 */
	@SuppressWarnings("unused")
	private boolean connectToServer() {
		...
		try {
			...
			if (server != null) {
				...
				System.out.println("    Address = " + server.getServerAddress() + ":" + server.getServerPort());
				socket = new Socket(server.getServerAddress(), server.getServerPort());
				server.listen();
			} else {
	 ...
	 * 
	 * @return <b>Server</b> instance. <b>Null</b> if player does not want to be host.
	 * @throws IOException
	 */
