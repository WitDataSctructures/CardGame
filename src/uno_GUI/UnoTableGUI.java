...
public class UnoTableGUI extends JFrame implements InputManager, ActionListener {
	...
	/**
	 * A Constructor for the window which the gui will be placed in, with all of the required buttons and lists placed where they need to be.
	 */
	public UnoTableGUI() {
	...
	/**
	 * Does a required task whenever a button on the GUI is pressed by the user. These buttons include drawing a card, calling uno, and selecting a card to play.
	 * 
	 * @param event
	 ...
	 * 
	 * @return String IP address that the user entered.
	 */
	@Override
	 ...
	 * 
	 * @return Color desired switch color
	 */
	@Override
